...
public class GeoJsonExportService {
    ...
    private void writeFeature(JsonGenerator g, CimObjectRecord rec,
        ...
        // Type — use the legacy label for this cimType, falling back to the
        // cimType verbatim if no mapping is defined.
        String label = LABEL_FOR_CIM_TYPE.getOrDefault(
                rec.getCimType(), rec.getCimType());
